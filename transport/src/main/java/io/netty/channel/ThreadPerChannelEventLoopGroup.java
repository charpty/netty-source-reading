 ...
 * ThreadPerChannelEventLoopGroup通常用于阻塞型传输，和JDK的socket编程类似，为每个channel创建一个线程
 * OioEventLoopGroup就是典型子类
 */
public class ThreadPerChannelEventLoopGroup extends AbstractEventExecutorGroup implements EventLoopGroup {
    ...
    final Set<EventLoop> activeChildren = Collections.newSetFromMap(PlatformDependent.<EventLoop, Boolean>newConcurrentHashMap());
     ...
     *         Use {@code 0} to use no limit
     * @param threadFactory
     *         the {@link ThreadFactory} used to create new {@link Thread} instances that handle the
     *         registered {@link Channel}s
     * @param args
     *         arguments which will passed to each {@link #newChild(Object...)} call.
     */
     ...
     *         Use {@code 0} to use no limit
     * @param executor
     *         the {@link Executor} used to create new {@link Thread} instances that handle the
     *         registered {@link Channel}s
     * @param args
     *         arguments which will passed to each {@link #newChild(Object...)} call.
     */
    protected ThreadPerChannelEventLoopGroup(int maxChannels, Executor executor, Object... args) {
        ...
        tooManyChannels = ThrowableUtil
                .unknownStackTrace(new ChannelException("too many channels (max: " + maxChannels + ')'), ThreadPerChannelEventLoopGroup.class, "nextChild()");
    }
